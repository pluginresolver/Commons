...
public class FriendCommands {
	...
	@SubCommand(name = "help", parent = "friends")
	...
	@SubCommand(name = "add", parent = "friends")
	...
	@SubCommand(name = "remove", parent = "friends")
	...
	@SubCommand(name = "requests", parent = "friends")
	...
	@SubCommand(name = "deny", parent = "friends")
	...
	@SubCommand(name = "accept", parent = "friends")
	...
	@SubCommand(name = "list", parent = "friends")
